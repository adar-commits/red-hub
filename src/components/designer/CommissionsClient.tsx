...
const ACCRUAL_STAT_TOOLTIP = `בצבירה: העמלות שצברת עד כה. לתשלום נדרש סכום מצטבר של לפחות ${MIN_INVOICE_UPLOAD_ACCRUAL_ILS} ש״ח.`;
const MODAL_INVOICE_MINIMUM_NOTE = `ניתן להעלות חשבונית לתשלום אך ורק במידה וסכום העמלות הממתינות לתשלום הינו לפחות ${MIN_INVOICE_UPLOAD_ACCRUAL_ILS} ש״ח`;
        ...
        >
          ...
          <div className="space-y-4 p-5">
            <div className="rounded-xl border-e-4 border-[var(--brand-red)] bg-gradient-to-l from-red-50/90 to-white pe-4 ps-3 py-3">
              ...
              <p className="mt-2 text-sm leading-relaxed text-gray-700">{MODAL_INVOICE_MINIMUM_NOTE}</p>
            </div>
