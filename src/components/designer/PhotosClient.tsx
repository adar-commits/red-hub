      ...
      <form noValidate onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full appearance-none rounded-xl border border-gray-300 bg-white px-4 py-3 text-gray-900 placeholder:text-slate-600 max-sm:border-2 max-sm:border-gray-400 focus:border-[var(--brand-red)] focus:ring-2 focus:ring-[var(--brand-red)]/20 focus:outline-none resize-y"
            required
          />
        </div>
