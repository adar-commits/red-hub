...
export function StatCard({
  ...
  return (
    <div
      className="group relative rounded-2xl border border-gray-300 bg-[var(--card-bg)] p-4 shadow-[0_1px_2px_rgba(15,23,42,0.06)] transition-shadow duration-200 hover:shadow-md"
      style={{ borderRadius: "var(--radius-card)" }}
    >
      {/* Clip only the hover glow — not tooltips that extend below the card */}
      <div
